...
| Distribuição de leads 100% manual | 🟡 Implementado (1.10), aguardando aplicação da migration 042 em produção | `lib/lead-distribution.ts`, migration 042, `BL-0028` (sem vendedor ativo/inativo) |
